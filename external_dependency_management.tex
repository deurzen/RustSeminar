...
exactly  those  types are  to  provide.  \wmrs's \mintinline{rust}{Cycle}  trait
introduces a generic  type, \mintinline{rust}{T}, that is  \textit{bound} by the
restriction  \mintinline{rust}{Identify  +  Debug},  stipulating  that  whatever
